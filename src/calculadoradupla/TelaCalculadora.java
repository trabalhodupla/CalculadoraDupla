            ...
            public boolean dispatchKeyEvent(java.awt.event.KeyEvent e) {
                 ...
                 if (e.getID() == java.awt.event.KeyEvent.KEY_TYPED) {
                    ...
                    if (Character.isDigit(tecla) || tecla == '.') {
                        ...
                        String textoVisor = txtVisor.getText().replace(",", ".");
                        primeiroValor = Double.parseDouble(textoVisor);
                        operacao = "divisao";
                        txtVisor.setText("");
                        e.consume();
                    }
                ...
                if (e.getID() == java.awt.event.KeyEvent.KEY_PRESSED) {
                    // Tecla ENTER: Executa o cálculo
                    if (e.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
                        try { 
                            String textoVisor = txtVisor.getText().replace(",", ".");
                            segundoValor = Double.parseDouble(textoVisor); 
                            ...
                            txtVisor.setText(df.format(resultado));
    ...
    private void btnIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIgualActionPerformed
       try {
        ...
        case "divisao": 
            ...
            break; 
        case "porcentagem": 
             String textoPorcentagem = txtVisor.getText().replace(",", ".");
            if (!textoPorcentagem.isEmpty()) {
                double resultadoFinal = Double.parseDouble(textoPorcentagem);
                txtVisor.setText(df.format(resultadoFinal));
                primeiroValor = resultadoFinal; // Salva para você continuar somando se quiser
            }
            break; 
    }
            } catch (Exception e) {
...
try {
        String textoVisor = txtVisor.getText().replace(",", ".");
            ...
            java.text.DecimalFormat df = new java.text.DecimalFormat("0.00");
            double valorPorcentagem = (primeiroValor * segundoValor) / 100;
            txtVisor.setText(df.format(valorPorcentagem));
        }
    } catch (Exception e) {
        txtVisor.setText("Erro");
    }        // TODO add your handling code here:
